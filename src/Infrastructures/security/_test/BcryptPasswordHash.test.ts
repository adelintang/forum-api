...
interface BcryptEncryptionHelperType {
...
describe('BcryptEncryptionHelper', () => {
  ...
  describe('comparePassword function', () => {
    ...
    it('should not return AuthenticationError if password match', async () => {
      // Arrange
      const bcryptEncryptionHelper: BcryptEncryptionHelperType = new BcryptEncryptionHelper(bcrypt)
      const plainPassword = 'secret'
      const encryptedPassword: string = await bcryptEncryptionHelper.hash(plainPassword)
